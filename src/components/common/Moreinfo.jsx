...
const MoreInfo = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-cover bg-center">
      <div className="relative h-[800px] md:h-[800px] w-full flex flex-col items-center justify-center">
        <div className="absolute w-full h-full overflow-hidden">
          {/* Gradient Overlay */}
          <img src={bg} alt="Background" className="absolute top-0 left-0 w-full h-full  lg:h-[70%] object-cover" />

        </div>

        {/* Text Overlay Section */}
        <div className="absolute lg:top-[-10%] left-0 w-full h-full flex flex-col justify-center items-center text-white p-8">
          <h1 className="text-2xl md:text-4xl font-bold mb-4 text-center">
            Discover the Best Astrologer Online for Consultation
          </h1>

          <div className="mb-8 mx-4 md:mx-[100px] lg:mx-[250px]">
            <h4 className="text-sm md:text-md font-semibold text-center">
