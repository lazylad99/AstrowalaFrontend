...
const QuickLinks = ["Home", "About", "Services", "Courses", "Products", "Recorded Courses", "Contact Us"];
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          <div className="flex">
            {BottomFooter.map((ele, ind) => (
              <div
                key={ind}
                className={`${
                  BottomFooter.length - 1 === ind ? "" : "border-r border-richblack-700"
          ...
          <div className="text-center flex flex-col sm:flex-row">
            <div className="flex">
              ...
              <Link to=" " target="__blank" className="text-white hover:underline ml-1">
                CODE_YOGIS
              </Link>
            </div>
