...
const Navbar = () => {
    ...
    return (
        <nav className={`z-[10] flex h-16 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar} `}>
