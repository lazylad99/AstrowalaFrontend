    ...
    <div className="flex w-full flex-col gap-5 text-white ">
      <div className="w-full mt-3 flex h-fit flex-col gap-5 lg:grid lg:grid-cols-12">
        <div className="col-span-4 lg:!mb-0 ">
          <CardComponent
            extra={
              "items-center w-full h-3/4 p-[16px] bg-black shadow1"
            }
          >
            ...
            {/* Post followers */}
            <div className="mt-6 mb-3 flex gap-4 md:!gap-14 text-white ">
        ...
        <div className="col-span-5 lg:col-span-6 lg:mb-0 3xl:col-span-5 shadow1  rounded-2xl ">
          <CardComponent extra={"w-full h-full p-3  mb-3 bg-black"}>
            {/* Header */}
            <div className="mt-2 mb-8 w-full text-white ">
