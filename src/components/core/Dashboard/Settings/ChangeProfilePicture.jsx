          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={handleClick}
                disabled={loading}
                className="cursor-pointer rounded-md py-2 px-5 font-semibold bg-richwhite-200 text-richwhite-900 hover:bg-richwhite-900 hover:text-richwhite-200 duration-300"
              >
                Select
              </button>
