...
export default function VideoDetailsSidebar({ setReviewModal }) {
  ...
  return (
    <>
      <div className="flex h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] border-r-richwhite-700 bg-richwhite-800">
        <div className="mx-5 flex flex-col items-start justify-between gap-2 gap-y-4 border-b border-richwhite-600 py-5 text-lg font-bold text-richwhite-25">
          <div className="flex w-full items-center justify-between ">
            ...
            <button
              ...
              className="flex h-[35px] w-[35px] items-center justify-center rounded-full bg-richwhite-100 p-1 text-richwhite-700 hover:scale-90"
              title="back"
            >
        ...
        <div className="h-[calc(100vh - 5rem)] overflow-y-auto">
          {courseSectionData.map((section, index) => (
            ...
            >
              {/* Section */}
              <div className="flex justify-between bg-richwhite-700 px-5 py-4">
                    ...
                    <div
                      className={`flex gap-3  px-5 py-2 ${
                        videoBarActive === topic._id
                          ? "bg-yellow-200 font-semibold text-richwhite-800"
                          : "hover:bg-richwhite-900"
                      } `}
                      key={i}
                      onClick={() => {
                        navigate(
